...
import {C_PROPERTY, C_URL_HANDLER, C_URL_PREFIX, C_URL_TITLE} from '../../../system/constants';
...
export class SimpleHtmlCellRouterLinkRendererComponent {
  ...
  getRouterLinkHandle(): (entry: any, row: any) => string[] {
    return _.get(this.column, C_URL_HANDLER);
  }


  getTitleHandle(): (entry: any, row: any) => string {
    return _.get(this.column, C_URL_TITLE);
  }
